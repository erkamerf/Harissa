...
function init_gear_sets()
	...
	sets.precast.WS['Savage Blade'] = {range=empty,ammo="Regal Gem",
		...
		body="Viti. Tabard +1",hands="Atrophy Gloves +2",ring1="Ifrit Ring +1",ring2="Rufescent Ring",
    ...
    sets.midcast.Cure = {main="Daybreak",sub="Sors Shield",range=empty,ammo="Hasty Pinion +1",
        ...
        body="Viti. Tabard +1",hands="Kaykaus Cuffs",ring1="Janniston Ring",ring2="Menelaus's Ring",
	...
	sets.midcast['Enhancing Magic'] = {main="Oranyan",sub="Culminus",range=empty,ammo="Hasty Pinion +1",
		...
		body="Viti. Tabard +1",hands="Atrophy Gloves +2",ring1="Stikini Ring +1",ring2="Metamor. Ring +1",
	...
	sets.EnhancingSkill = {main="Pukulatmuj +1",head="Befouled Crown",neck="Incanter's Torque",ear2="Mimir Earring",hands="Viti. Gloves +1",back="Ghostfyre Cape",waist="Olympus Sash",legs="Atrophy Tights +2"}
	...
	sets.midcast.Sleep = set_combine(sets.midcast.DurationOnlyEnfeebling,{waist="Null Belt"})
	sets.midcast.Sleep.Resistant = set_combine(sets.midcast['Enfeebling Magic'].Resistant,{waist="Null Belt"})
	sets.midcast.Bind = set_combine(sets.midcast.DurationOnlyEnfeebling,{waist="Null Belt"})
	sets.midcast.Bind.Resistant = set_combine(sets.midcast['Enfeebling Magic'].Resistant,{waist="Null Belt"})
	sets.midcast.Break = set_combine(sets.midcast.DurationOnlyEnfeebling,{waist="Null Belt"})
	sets.midcast.Break.Resistant = set_combine(sets.midcast['Enfeebling Magic'].Resistant,{waist="Null Belt"})
	
	sets.midcast.Dispel = sets.midcast['Enfeebling Magic'].Resistant
	
	sets.midcast.SkillBasedEnfeebling = set_combine(sets.midcast['Enfeebling Magic'], {ear1="Vor Earring",hands="Leth. Gantherots +2",ring1="Stikini Ring +1",legs="Psycloth Lappas"})
	...
	sets.midcast.Impact = {main="Bunzi's Rod",sub="Culminus",range="Ullr",ammo=empty,
...
--		back=gear.stp_jse_back,waist="Sarissapho. Belt +1",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"}
	...
	sets.engaged.EnspellOnly = {
		head="Malignance Chapeau",neck="Dls. Torque +2",ear1="Suppanomimi",ear2="Leth. Earring +2",
	...
	sets.engaged.DT = {ammo="Aurgelmir Orb +1",
		...
		back="Moonlight Cape",waist="Sarissapho. Belt",legs="Malignance Tights",feet="Battlecast Gaiters"}
	...
	sets.engaged.DW = {ammo="Aurgelmir Orb +1",
		...
		back=gear.stp_jse_back,waist="Reiki Yotai",legs="Carmine Cuisses +1",feet="Malignance Boots"}
	...
	sets.engaged.DW.Acc = {ammo="Aurgelmir Orb +1",
		...
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Ramuh Ring +1",ring2="Chirich Ring +1",
		back=gear.stp_jse_back,waist="Reiki Yotai",legs="Carmine Cuisses +1",feet="Malignance Boots"}
